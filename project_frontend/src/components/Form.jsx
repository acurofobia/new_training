  ...
  return (
    <form className='form' onSubmit={handleSubmit(handleSubmitForm)}>
      ...
      <input className='input' type="text" id='username' value={username} 
        {...register("username", {required: true, pattern: /^([A-Za-z0-9А-Яа-я]){1,20}$/gm})} 
        onChange={(e) => setUsername(e.target.value)} />
      <label htmlFor="username">{errors.username && "Логин 1-10 символов, латинница/кириллица и цифры"}</label>
